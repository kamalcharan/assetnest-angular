...
export const ROUTES: RouteInfo[] = [
        ...
        { path: '/pages/Home', title: 'Home', icon: 'ft-calendar', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
        { path: '/Customers', title: 'Customer', icon: 'ft-calendar', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
        { path: '/Subscriptions', title: 'Subscriptions', icon: 'ft-calendar', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
        { path: '/Invoices', title: 'Invoices', icon: 'ft-calendar', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
        { path: '/Reports', title: 'Reports', icon: 'ft-calendar', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
        { path: '/pages/Settings', title: 'Configuration', icon: 'ft-calendar', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
        { path: '/pages/Settings2', title: 'Configuration2', icon: 'ft-calendar', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] }
